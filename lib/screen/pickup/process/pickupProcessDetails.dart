...
class PickupProcessDetail extends StatefulWidget {
  const PickupProcessDetail({super.key});

  @override
  State<PickupProcessDetail> createState() => _PickupProcessDetailState();
}

class _PickupProcessDetailState extends State<PickupProcessDetail> {
